  ...
  return (
    <div className="bg-white flex flex-col rounded-md p-5 mb-4">
      ...
      <FieldsetRadio
        ...
        {...register(`beneficiaries.${beneficiaryNumber}.title`)}
        className="my-2"
      />
      <InputText
        id="first_name"
        label="First name"
        {...register(`beneficiaries.${beneficiaryNumber}.first_name`)}
        className="my-2"
      />
      <InputText
        id="last_name"
        label="Last name"
        {...register(`beneficiaries.${beneficiaryNumber}.last_name`)}
        className="my-2"
      />
      <Controller
        name={`beneficiaries.${beneficiaryNumber}.birth_date`}
        control={control}
